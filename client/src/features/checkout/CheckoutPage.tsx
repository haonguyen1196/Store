...
const stripePromise = loadStripe(import.meta.env.VITE_STRIPE_PK); // Khởi tạo Stripe
...
export default function CheckoutPage() {
    ...
    useEffect(() => {
        ...
        create.current = true;
    }, [createPaymentIntent]); // tránh useEffect gọi nhiều lần
    ...
    }, [basket?.clientSecret, darkMode]); // Thiết lập options cho Elements khi có clientSecret, form, css,...
